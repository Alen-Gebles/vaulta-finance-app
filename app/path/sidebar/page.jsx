  ...
  return (
    <section className={`sidebar ${minimize ? 'sidebar-hide' : ''}`}  >
      ...
      <div className='sidebar-link-box'>
        <Link href='/' className={`sidebar-link ${minimize ? 'justify-end' : ''}`}>
        ...
        <Link href='/path/transactions' className={`sidebar-link ${minimize ? 'justify-end' : ''}`}>
        ...
        <Link href='/path/budgets' className={`sidebar-link ${minimize ? 'justify-end' : ''}`}>
        ...
        <Link href='/path/pots' className={`sidebar-link ${minimize ? 'justify-end' : ''}`}>
        ...
        <Link href='/path/recurring-bills' className={`sidebar-link ${minimize ? 'justify-end' : ''}`}>
